...
public class GroupDetailFrm extends javax.swing.JFrame {
    ...
    public GroupDetailFrm(PlayerCtr ro, Player pl, Group gr) {
        initComponents();
        mySocket = ro;
        this.player = pl;
        this.group = gr;
        ...
        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.REPLY_LIST_APPROVAL, this));
        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.REPLY_CHECK_JOIN_APPROVAL, this));

        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.REPLY_DELETE_GROUP, this));
        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.REPLY_LIST_MEMBER, this));
        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.REPLY_CHECK_LEAVE, this));
        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.REPLY_CHECK_JOIN, this));
        ...
        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.REPLY_ACCEPT_GROUP, this));
    ...
    public void tbl_listApproval(ObjectWrapper data) {
    ...
    public void joinGroup(ObjectWrapper data) {
        if (data.getData().equals("ok")) {
    ...
    private void btnJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJoinActionPerformed
        ...
        mySocket.sendData(new ObjectWrapper(ObjectWrapper.JOIN_GROUP, group));
    ...
    private void btnLeaveGroupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLeaveGroupActionPerformed
        ...
        group.setIdplayer(player.getId_player());
        group.setNameGroup(group.getNameGroup());
        mySocket.sendData(new ObjectWrapper(ObjectWrapper.LEAVE_GROUP, group));
    ...
    public void acceptGroup(ObjectWrapper data) {
        if (data.getData().equals("ok")) {
            ...
            mySocket.sendData(new ObjectWrapper(ObjectWrapper.LIST_GROUP, player));
            mySocket.sendData(new ObjectWrapper(ObjectWrapper.LIST_APPROVAL, gr));
    ...
    private void btnAcceptJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptJoinActionPerformed
        // TODO add your handling code here:
        mySocket.sendData(new ObjectWrapper(ObjectWrapper.ACCEPT_GROUP, gr));
    ...
    private void btnDeleteGroupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteGroupActionPerformed
        // TODO add your handling code here:
        mySocket.sendData(new ObjectWrapper(ObjectWrapper.DELETE_GROUP, group));
